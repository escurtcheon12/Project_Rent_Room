  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="row">
        	...
        	<div class="square first_floor col-lg-6">
        		<div class="square_color">1</div>
        		<div class="square_color">2</div>
        		<div class="square_color">3</div>
        		<div class="square_color">4</div>
        		<div class="square_color">5</div>
        	</div>

        	<p class="twost">2st Floor</p>
        	<div class="square second_floor col-lg-6">
        		<div class="square_color">6</div>
        		<div class="square_color">7</div>
        		<div class="square_color">8</div>
        		<div class="square_color">9</div>
        		<div class="square_color">10</div>
        	</div>
        </div>
      </div>
      ...
      <div class="modal-footer">
        ...
        <a href="../process/aggrement.php" class="btn">Book</a>
