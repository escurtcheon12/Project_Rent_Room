    ...
    <form action="booking_process.php" method="POST">
      ...
      <div class="input-group mb-3">
        <label for="name">Current Address :</label>
          ...
          <div style="width: 450px;" class="first-field col-lg-12">
              <input name="street_address" type="text" class="form-control" id="address" placeholder="Street Address">
          </div>
          </div>

         <div class=" row">
            <div class=" second-field col-lg-6">
               <input name="city" type="text" class="form-control" id="address" placeholder="City">
            </div>
            <div class="second-field col-lg-6">
               <input name="region" type="text" class="form-control" id="address" placeholder="Region">
            </div>
          </div>

          <div class=" row">
            <div class="three-field col-lg-6">
               <input name="postal_code" type="text" class="form-control" id="address" placeholder="Postal Code">
            </div>
            <div class="three-field  col-lg-6">
               <input name="country" type="text" class="form-control" id="address" placeholder="Country">
            </div>
          </div>
      </div>
      ...
      <div class="input-group mb-3">
        <label for="number-telp">Phone Number :</label>
          <input name="number-telp" type="number" class="form-control" id="number-telp" placeholder="Your Phone Number" >
      </div>

      <div class="input-group mb-3">
        <label for="when">When do you want to move in?</label>
          <input name="when" type="date" class="form-control" id="when">
      </div>

      <div class="input-group mb-3">
        <label for="floor">Floor :</label>
        <select style="margin-left: 10px;" name="floor" class="form-select" aria-label="form-select-lg example">
      ...
      <div class="input-group mb-3">
        ...
        <select style="margin-left: 10px;" id="room" name="room" class="form-select" aria-label="form-select-lg example">
      ...
      <div class="input-group mb-3">
        ...
        <select style="margin-left: 10px;" id="payment" name="payment" class="form-select" aria-label="form-select-lg example">
